1.サービス概要
　利益と減価償却費を入れて、借入（予定）額を入力するだけで、自分の返済能力がわかるシンプルなアプリです。

2.![デモ画面](images/demo/デモ画像.png)

3.サービスURL
https://fin-app-kota-f0138686ce69.herokuapp.com/calculations/new
